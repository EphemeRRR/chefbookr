...
puts ""
  ...
  menu1 = Menu.create!(price: (15..30).to_a.sample, courses: (1..3).to_a.sample, chef: chef1, category: "Simple", description: "Menu basic avec\r\n entrée-plat-dessert\r\n", photo_id: File.open(File.join(Rails.root, "/app/assets/images/seed/menu#{(1..9).to_a.sample.to_i}.jpg")))
  menu2 = Menu.create!(price: (30..60).to_a.sample, courses: (3..5).to_a.sample, chef: chef1, category: "Classic", description: "Menu un peu plus copieux\r\n avec\r\n de nombreux à cotés", photo_id: File.open(File.join(Rails.root, "/app/assets/images/seed/menu#{(1..9).to_a.sample.to_i}.jpg")))
  menu3 = Menu.create!(price: (60..160).to_a.sample, courses: (5..7).to_a.sample, chef: chef1, category: "Gourmet", description: "Super menu,\r\n buffet, boisson, \r\n LA TOTALE!!!", photo_id: File.open(File.join(Rails.root, "/app/assets/images/seed/menu#{(1..9).to_a.sample.to_i}.jpg")))
